    ...
    <body class="antialiased bg-body text-body font-body">
        <div>
            ...
            <div class="hidden lg:block navbar-menu relative z-50">
                <div
                    class="navbar-backdrop fixed lg:hidden inset-0 bg-gray-800 opacity-10"></div>
                <nav
                    ...
                    <div class="px-4 pb-6">
                        ...
                        <div class="absolute bottom-2 left-4 right-4">
                            <a
                                class="w-full flex items-center pl-3 py-3 pr-2 text-gray-50 hover:bg-gray-900 rounded"
                                href="#">
            ...
            <div class="mx-auto lg:ml-80">
                ...
                <section class="py-5 px-6 bg-white shadow hidden lg:block">
                    <div class="flex items-center justify-end">
                        ...
                        <img
                            class="ml-3 w-10 h-10 rounded-full object-cover object-right"
